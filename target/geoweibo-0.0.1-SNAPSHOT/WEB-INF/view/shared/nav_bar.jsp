...
<body>
			<div class="navbar-default sidebar" style="top:52px"  role="navigation" >
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu" > 
             <%--            <li>
                            <a href="${ctx}/chart/login.do"><i class="fa fa-dashboard fa-fw nav_icon"></i>登录</a>
                        </li> --%>
                        <li>
						 ...
						 <li>
                            <a href="${ctx}/chart/point.do"><i class="fa fa-sitemap fa-fw nav_icon"></i>雅安地震微博地图<span class="fa arrow"></span></a>
                        </li>
						<!-- 原Mailbox -->
                        <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw nav_icon"></i>数据申请<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
               					<%-- <li>
                                    <a href="${ctx}/chart/forms.do">账号申请</a>
                                </li>  --%>
                                <li>
                                    <a href="${ctx}/chart/compose.do">计算申请</a>
                                </li>
                                 <li>
                                    <a href="${ctx}/chart/download.do">结果下载</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
