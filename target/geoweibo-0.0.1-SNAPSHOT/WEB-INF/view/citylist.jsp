	      ...
	      <li><a href="${ctx}/chart/citylist.do">微博统计图</a></li>
			...
			<!--map!-->
							    ...
							    require.config({
								    ...
								    $(function(){
							    		require(['echarts','echarts/chart/wordCloud'],DrawEChart);
							    	});
								    ...
								    function DrawEChart(ec) {
								    	...
								    	//异步加载数据显示
								    	$.getJSON('${ctx}/chart/wordcloudjson.do?date=2015-11-01', function (data) {
	...
	function returndate(value){
		 require.config({
		    ...
		    function DrawEChart(ec) {
		    	...
		    	//异步加载数据显示
		    	$.getJSON('${ctx}/chart/wordcloudjson.do?date='+value, function (data) {
			    	myChart.setOption(data);
			    	myChart.hideLoading();
	   	        });  
	    	}
