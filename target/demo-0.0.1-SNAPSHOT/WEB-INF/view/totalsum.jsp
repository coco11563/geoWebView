...
<div id="wrapper">
     <!-- Navigation -->
	    ...
	    <div class="graph_box">
		   ...
		   <label for="meeting">选择查询日期：</label><input id="meeting" type="date" value="2015-08-13"/> 
		   <label for="meeting">至  </label>
		   <input id="meeting" type="date" value="2015-09-13"/>
		   </div>
...
require(
    ...
    title : {
        text: '微博数据总体统计图',
        subtext: '日期：2015年9月13日至2015年9月13日',
        x:'center'
    },
    tooltip : {
        trigger: 'item'
